package testautomation.ui.uibase;
...
public class UI_Base {
    ...
    public static Logger logger = Logger.getLogger("UI_Automation");
    public static Logger log = (Logger) LogManager.getLogger(UI_Base.class.getName());
    ...
    public static Properties getPropertyFile() {
        ...
        try {
            ...
            properties.load(new FileInputStream("./src/main/resources/UIConfig.properties"));
        } catch (Exception e) {
    ...
    public static String getProperty(String key) throws FileNotFoundException, IOException {
        ...
        prop.load(new FileInputStream(getPath() + "\\src\\test\\resources\\UIConfig.properties"));
...
//	}
    ...
    public static void browserCapture(String fileName) {
        File srcFile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
        File desFile = new File("./src/test/resources/Screenshots/UI_Screenshots");
        if (!desFile.exists()) {
            desFile.mkdirs();
        }
        ...
        try {
            ...
            System.err.println("Unable to take the ScreenShot: " + e.getMessage());
        }
    }
